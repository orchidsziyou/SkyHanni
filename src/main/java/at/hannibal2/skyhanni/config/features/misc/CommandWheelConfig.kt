...
class CommandWheelConfig {
    ...
    @Expose
    @ConfigOption(name = "Up", desc = "Text for the up direction.\nStart with '/' to run it as a command (e.g. /ah), otherwise it is sent as a chat message (e.g. leap me). Leave empty to hide this direction.")
    @ConfigEditorText
    var slotUp: String = "/ah"

    @Expose
    @ConfigOption(name = "Up Right", desc = "Same as Up.")
    @ConfigEditorText
    var slotUpRight: String = ""

    @Expose
    @ConfigOption(name = "Right", desc = "Same as Up.")
    @ConfigEditorText
    var slotRight: String = ""

    @Expose
    @ConfigOption(name = "Down Right", desc = "Same as Up.")
    @ConfigEditorText
    var slotDownRight: String = ""

    @Expose
    @ConfigOption(name = "Down", desc = "Same as Up.")
    @ConfigEditorText
    var slotDown: String = "/bz"

    @Expose
    @ConfigOption(name = "Down Left", desc = "Same as Up.")
    @ConfigEditorText
    var slotDownLeft: String = ""

    @Expose
    @ConfigOption(name = "Left", desc = "Same as Up.")
    @ConfigEditorText
    var slotLeft: String = ""

    @Expose
    @ConfigOption(name = "Up Left", desc = "Same as Up.")
    @ConfigEditorText
